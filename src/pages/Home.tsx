                ...
                <div className="flex flex-col items-start">
                    ...
                    >
                        <a
                            ...
                            className="group relative overflow-hidden flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-brand-cyan text-brand-dark font-bold text-sm tracking-wider uppercase shadow-[0_0_30px_rgba(0,163,196,0.4)] hover:shadow-[0_0_50px_rgba(0,163,196,0.7)] transition-all duration-500 hover:-translate-y-0.5"
                        >
                ...
                >
                    ...
                    <div className="relative w-full max-w-[420px] h-[300px]">
                        ...
                        <div className="absolute inset-0 rounded-[2rem] p-[1.5px] z-10"
                            style={{ background: 'linear-gradient(135deg, rgba(0,163,196,0.8) 0%, rgba(255,255,255,0.05) 40%, rgba(0,163,196,0.4) 70%, rgba(0,212,255,0.6) 100%)' }}
                        >
                            {/* Main image card */}
                                    ...
                                    <div className="flex gap-1.5 items-center">
                                        {previewImages.map((_, i) => (
                                            <button
                                                ...
                                                className={`rounded-full transition-all duration-300 ${i === activeImage ? 'w-5 h-1.5 bg-brand-cyan shadow-[0_0_6px_rgba(0,163,196,0.8)]' : 'w-1.5 h-1.5 bg-white/30 hover:bg-white/60'}`}
                                            />
                                        ))}
                                    </div>
                                </div>
