  ...
  return (
    <AdminLayout>
      ...
      {selectedBooking && (
        ...
        >
          <div 
            className="bg-[#0f172a] w-full max-w-2xl rounded-3xl border border-brand-cyan/30 overflow-hidden shadow-[0_0_50px_rgba(0, 180, 216,0.2)]"
          ...
          >
            ...
            <div className="p-6 border-t border-white/10 bg-white/5 flex justify-end gap-3">
              ...
              <button
                ...
                className="px-6 py-3 bg-brand-cyan text-[#0f172a] rounded-xl font-bold hover:bg-[#48CAE4] transition-all flex items-center gap-2 shadow-[0_0_20px_rgba(0, 180, 216,0.3)] hover:shadow-[0_0_30px_rgba(0, 180, 216,0.5)] transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {sendingEmail ? (
                  <>
