...
function App() {
  // Lightbox State (shared across components through props if needed)
        ...
        <AnimatePresence>
          {
            lightboxOpen && lightboxImages.length > 0 && (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="fixed inset-0 z-[100] bg-brand-dark/95 backdrop-blur-md flex items-center justify-center"
